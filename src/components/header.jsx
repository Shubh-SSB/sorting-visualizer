const Header = ({ darkMode, setDarkMode }) => {
    ...
    return (
        <div className="flex rounded-lg border-2 border-purple-600 items-center gap-80 p-4">
            <div className="my-4 flex rounded-lg text-start">
            ...
            <div className="flex flex-row gap-96 items-center">
                ...
                <a href="https://www.codetatva.in/" className="text-purple-600 font-normal font-serif text-4xl">Learn</a>
